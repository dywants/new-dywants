    ...
    return (
        <SectionServices>
            <div className="wrapper py-20">
                ...
                <Title
                    white
                    className="lg:w-[777px] mb-10"
                    title="Nous avons toutes l'expertise et les compétences qu'il faut pour mener à bien vos projets web et digitaux."
                />
                <LinkElement
                    href={route("services")}
                    primary
                    className="mt-12 w-full ml-0"
                >
                    Voir nos services web
                    <img
                        className="w-6 h-6 ml-1 inline-flex"
                        src="assets/images/icons/right-arrow.png"
                        alt="right-arrow icon"
                    />
                </LinkElement>
                <div className="card3 mt-8">
