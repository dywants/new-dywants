                    ...
                    <div className="h-screen text-center flex justify-start w-full md:w-[798px] mx-auto">
                        <div>
                            ...
                            <p className="text-white text-[25px] mt-[30px] mb-[41px]">
                                ...
                                expérience différentes à travers une application
                                ou un site web rapide et sécurisé.
                            </p>
                            <div>
                ...
                <div className="wrapper">
                    <Wrapper>
                        <div className="flex-1">
                            ...
                            <p>
                                Votre site internet est enfin prêt! Il ne reste
                                plus qu’à le rendre disponible auprès de votre
                                cible.
                            </p>
                            <p>
                                Nous vous accompagnons tout au long du processus
                                de mise en ligne de votre site internet.{" "}
                            </p>
                            <div className="mt-4">
                        ...
                        <div className="flex-1">
                            <Image
                                src={"/assets/images/devops/devops-image1.png"}
                            />
                        </div>
                    </Wrapper>
                </div>
                    ...
                    <div className="flex-1 px-6 md:px-0 md:mr-20">
                        <div className="px-5">
                            ...
                            <p className="text-base text-texte leading-7 mb-2">
                                Vous n’avez pas d’adresse web ? Vous n’êtes pas
                                propriétaire de votre nom de domaine ? vous
                                n’avez pas d’hébergeur web ? Pas d’inquiétude.
                            </p>
                            <p className="text-base text-texte leading-7">
                                Nous gérons la mise en place de votre
                                hébergement Web et la gestion du nom de domaine.
                            </p>
                            <div className="mt-4">
                                <CustomLink secondary href={route("contact")}>
                                    Contactez-nous
                    ...
                    <Wrapper>
                        <div className="flex-1">
                            ...
                            <p>
                                ...
                                dernières technologies en matière de sécurité.
                            </p>
                            <div className="mt-4">
                                <CustomLink secondary href={route("contact")}>
                                    Contactez-nous
                        ...
                        <div className="flex-1">
                            <Image
                                src={"/assets/images/devops/devops-image3.png"}
                            />
                        </div>
                    </Wrapper>
                </div>
            ...
            <section>
                <div className="wrapper">
                    <div className="w-full md:max-w-xl">
                        <h2>
                            Nous utilisons{" "}
                            <span className="text-primary">les meilleurs</span>{" "}
                            outils
                        </h2>
                        <p className="mt-2 text-base text-texte leading-7">
                           Nous utilisons des technologies de pointes et nous sommes fières de le dire haut et fort.
                        </p>
                    </div>
