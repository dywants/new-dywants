    ...
    return (
        <>
            ...
            <Layout>
                <HeaderOtherPages
                    image={
                        "/assets/images/support-technique/support-technique.png"
                    }
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            <div className="flex-1">
                                <h2>
                                    Nous facilitons votre quotidien.
                        ...
                        <div className="flex-1 px-6 md:px-0 md:mr-20">
                            <div className="px-5">
                                ...
                                <p className=" text-texte mb-2">
                                    Nous mettons à disposition des entreprises
                                    un suivi instantannée au quotidien.
                                </p>
                                <p className=" text-texte">
                                    Nos experts previennent et extermine les
                                    différents obstacles afin d’eviter une
                                    quelconque rupture de service et garantir
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            <div className="flex-1">
                                ...
                                <p>
                                    En fonction de vos horaires et exigences,
                                    nous mettons à votre disposition un support
                                    technique efficace qui correspond totalement
                                    à vos besoins.
                                </p>
                            </div>
                            <div className="flex-1">
