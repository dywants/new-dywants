                ...
                <div className="container mx-auto max-w-6xl py-20 text-left">
                    <Wrapper>
                        <div className="flex-1">
                            <h2>
                                Créez des solutions infinies avec Vos données.
                            </h2>
                            <p>
                                Nous connectons notre outil à n’importe quelle
                                base de données de production et la transforme
                                en une feuille de calcul intelligente.
                            </p>
                            <p className="mt-2">
                                Vous pouvez ainsi consulter et traiter vos
                                données sans avoir les connaisnces techniques
                                nécessaires.
                            </p>
                            <div className="my-4">
                    ...
                    <Wrapper>
                        ...
                        <div className="flex-1">
                            ...
                            <p className="mt-2">
                                ...
                                Exploiter vos données sous différents formats.
                            </p>
                            <p className="mt-2">
                                Créez une vue de grille illimitée, une vue de
                                galerie, une vue de formulaire à partir de vos
                                propres données
                            </p>
                            <p className="mt-2">
                                Recherchez, triez, filtrez les colonnes et les
                                lignes en toute simplicité
                            </p>
                        </div>
                    </Wrapper>
                </div>
                ...
                <div className="container mx-auto max-w-6xl pb-14 text-left">
                    <Wrapper>
                        <div className="flex-1">
                            ...
                            <p className="mt-2">
                                Invitez votre équipe avec un contrôle d'accès
                                précis. Partagez des vues publiquement et
                    ...
                    <Wrapper>
                        ...
                        <div className="flex-1">
                            ...
                            <p className="mt-2">
                                ...
                                préférées : Microsoft Teams Slack, Discord,
