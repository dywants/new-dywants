                ...
                <div className="wrapper">
                    <Wrapper>
                        <div className="flex-1">
                            ...
                            <p>
                                Dolibarr un ERP open source qui est essentiel à
                                tous quelque soit la taille , le secteur,
                ...
                <div className="wrapper">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="max-w-[585px]">
                            ...
                            <p className="mt-1">
                                Dolibarr un ERP qui est essentiel à tous quelque
                                soit la taille , le secteur, l'activité
                                concernée. Pour les clients, les adhérents,les
                                factures, les cotisations, les stocks,la
                                comptabilité ....
                            </p>
                        </div>
                ...
                <div className="wrapper">
                    <Wrapper>
                        <div>
                            ...
                            <p>Nous mettons à votre disposition un outil pour gérer tous les différents aspects de votre entreprise.</p>
                            <div className="mt-4">
                                <LinkElement href={route('contact')}>Faire un devis</LinkElement>
                            </div>
                        </div>
                        <div>
                            <Image src={"/assets/images/dolibarr/section-extension-dolibarr.svg"}/>
                        </div>
                    </Wrapper>
                </div>
            </section>
