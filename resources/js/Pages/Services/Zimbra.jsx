    ...
    return (
        <>
            <Helmet>
                ...
                <link
                    rel="canonical"
                    href="https://dywants.com/services/digitalisation/integrateur-zimbra-au-cameroun/"
                />
            </Helmet>
            <Layout>
                <HeaderPage
                    ...
                    title={
                        "L'outil parfait pour la messagerie et la collaboration"
                    }
                    description={
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            <div className="flex-1">
                                ...
                                <p>
                                    Zimbra Collaboration est le premier
                                    fournisseur mondial de logiciels de
                                    collaboration par e-mail. Nous maitrisons
                                    cette outil pour vous afin de vous offrir ce
                                    qu’il y’a de mieux pour votre activité.
                                </p>
                                <div className="my-4">
                                    <CustomLink
                                        secondary
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            ...
                            <div className="flex-1">
                                ...
                                <p className="mt-2">
                                    Travailler simultanément avec votre équipe
                                    ou vos clients/partenaires. Cette solution
                                    permet:
                                </p>
                                <p>
                                    Le partage de notes, possède un intranet, la
                                    gestion des réunions, la planifications
                                    d’évènements, la synchronisation avec
                                    l’agendas et la base de savoir wiki.
                                </p>
                            </div>
                        </Wrapper>
                    </div>
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            ...
                            <div className="flex-1">
                                <Image
                                    src={
                                        "/assets/images/zimbra/comm-zimbra.png"
                                    }
                                />
                            </div>
                        </Wrapper>
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            ...
                            <div className="flex-1">
                                ...
                                <p className="mt-2">
                                    La gestion des documents est l’un des points
                                    fort de Zimbra. Il offre des fonctionnalités
                                    avancées qui vont faciliter largement votre
                                    expérience.
                                </p>
                                <p>
                                    Parmi elles nous avons : Le partage de
                                    dossier, le tableur et le texteur intégré,
                                    les modèles de documents, les horodatages,
                                    les versions de documents, visionneuse des
                                    documents et synchronisation...
                                </p>
                                <div className="my-4">
                                    <CustomLink
                                        secondary
