...
const N8n = () => {
    const titles = ["CBS", "Adobe", "Fielda", "Nova Benefits", "Pearson"];
    return (
        <>
            <Helmet>
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            <div className="flex-1">
                                ...
                                <p className="mt-2">
                                    Tous les processus répétitifs peuvent
                                    maintenant être gérer automatiquement sans
                                    intervention.
                                </p>
                                <div className="my-4">
                                    <CustomLink
                ...
                <section>
                    <div className="wrapper">
                        <Wrapper>
                            <div className="flex-1">
                                <Image
                                    src={"/assets/images/n8n/rentabilite.png"}
                                />
                            </div>
                            <div className="flex-1">
                                <h2>
                                ...
                                <p className="mt-2">
                                    Vous n’avez plus qu’à vous concentrer sur
                                    les tâches qui necessitent vraiment votre
                                    attention.
                                </p>
                                <p className="mt-2">
                                    Nous faisons tout le reste du travail pour
                                    vous.
                                </p>
                            </div>
                        </Wrapper>
                    ...
                    <div className="wrapper">
                        <Wrapper>
                            <div className="flex-1">
                                ...
                                <p className="mt-2">
                                    Des applications de communications,
                                    marketing de contenu, finance, ventes,
                                    producitivté, données et structures. Boostez
                                    maintenant votre activité.
                                </p>
                                <div className="my-4">
                                    <CustomLink
                                        secondary
                            ...
                            <div className="flex-1">
                                <Image
                                    src={
                                        "/assets/images/n8n/integration-n8n.png"
                                    }
                                />
                            </div>
                        </Wrapper>
                        ...
                        <div className="columns-1 md:columns-2 py-2">
                            <div className="py-2">
                                ...
                                <p className="font-light mb-2">
                                    ...
                                    déjà fait ses preuves. Notre expertise au
                                    service de votre entreprise afin de repondre
                                    à votre besoin de manière éfficace.
                                </p>
                            </div>
                            <div>
                                <p className="font-light mb-2">
                                    ...
                                    technologie, le service financier,
                                    l’education, la santé etc.
                                </p>
                            </div>
                        </div>
