...
export const InfoDigitalisation = {
    firstSection: [
        {
            title: "Nous avons tout ce qu’il vous faut pour faire évoluer votre business d’un cran",
            description:
            ...
            src: "/assets/images/digitalisation/collaboration.png",
    ...
    dolibarr: {
        info: [
            {
                title: "Dolibarr - Une suite Web pour gérer l'ensemble de votre entreprise",
                description:
    ...
    n8n: [
        {
            title: "n8n.io - Automatisez tous sans limites et faites passer votre flux de travail au max.",
            description:
    ...
    nocodb: [
        {
            title: "NocoDB - Analysez, traitez et collectez vos données autrements.",
            description:
...
export const ReasonWork = {
    titleSection:
        "Nous utilisons des outils open-sources car votre succès compte réellement pour nous!",
    description:
        "Dans notre stratégie d’accompagnement des entreprises dans leur processus de digitalisation nous avons le meilleur choix pour. Travaillez exclusivement avec les logiciels open-sources.",
    infoReason: [
        {
            id: uuidv4(),
            title: "La sécurité",
