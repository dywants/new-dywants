        ...
        <Layout>
            <div className="container mx-auto max-w-6xl mt-32">
                <SectionService  titlesection={"Qui sommes-nous?"}
                        ...
                        description={"Agence de développement informatique, basée à Cameroun, pour grandes entreprises, PME et associations. Constituée d'experts dans le développement des solutions digitales sur mesure, DYWANTS vous aide à porter votre entreprise au maximum de son potentiel, d’augmenter ses performances et développer votre activité à travers des outils performants et adaptés à vos besoins."}
                        describe={"Notre mission est de construire avec vous des solutions qui auront un impact fort pour vos utilisateurs et la croissance de votre business."}/>
                <Presentation/>
            </div>
            ...
            <div className='bg-[#EEF4FA]'> 
                ...
                <SectionService  titlesection={"Notre mission"}
                        ...
                        description={"Nous voulons permettre à nos clients d'atteindre leurs objectifs digitaux avec des solutions web qui change la donne."}/>
                <SectionService reverse titlesection={"Notre vision"}
                        title={"La performance"}
                        src={'/assets/images/apropos/vision.png'}
                        description={"Nous privilégions la qualité à la quantité, apportez des solutions à la pointe de la technologie est une condition pour nous."}/>
                </div>
            </div>
            <div >
